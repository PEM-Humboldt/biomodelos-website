...
- [Ruby](https://www.ruby-lang.org/en/documentation/) version 3.1.7. It is advisable to use [rbenv](https://github.com/rbenv/rbenv#installation) to install and manage ruby local version.
