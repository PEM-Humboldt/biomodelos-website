class HomeController < ApplicationController
	...
	def send_contact_form
		...
		recaptcha_v3_valid = verify_recaptcha(action: 'contact_us', minimum_score: 0.9, secret_key: Rails.application.credentials.dig(:recaptcha, :RECAPTCHA_SECRET_KEY_V3))
